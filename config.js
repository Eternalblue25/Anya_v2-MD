...
module.exports = {
     ...
     */
    botname: process.env.BotName || "CIPHER SPECTRE",
    ...
    ownernumber: process.env.Owner_Number || "254704706667",
    ...
    packname: process.env.PackName || "Queen ASSISTANT MD",
    ...
    sessionId: process.env.SESSION_ID || "bDExa3A_Queen-Anya_0eXU=",
